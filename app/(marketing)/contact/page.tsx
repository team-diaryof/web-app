    ...
    <AnimatePageWrapper className="py-24 bg-white overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-24 mb-32">
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <TextArea label="Message" name="message" placeholder="Tell us how we can help..." required className="min-h-[150px]" />
        ...
        <div className="w-full h-[400px] bg-zinc-100 rounded-3xl mb-32 relative overflow-hidden shadow-sm border border-zinc-200">
           <Map 
                position={[37.7577, -122.4376]} // Example coords (SF), change to Patna if desired [25.58, 85.09]
                title="DiaryOf HQ" 
