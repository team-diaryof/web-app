...
export default function ManageLayout({ children }: { children: ReactNode }) {
    ...
    return (
        <div className="min-h-screen bg-white text-zinc-900 font-sans selection:bg-yellow-100">
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <aside className="w-full lg:w-64 flex-shrink-0">
                        <nav className="flex flex-col space-y-1 sticky top-[115px]">
                            <div className="mb-8">
                                <Link href="/dashboard" className="inline-flex items-center text-sm text-zinc-400 hover:text-zinc-900 transition-colors mb-2">
                            ...
                            {NAV_ITEMS.map((item) => {
                                ...
                                return (
                                    ...
                                    >
                                        <span className={isActive ? "text-yellow-600" : "text-zinc-400"}>
                                            <item.icon size={18} />
                                        </span>
                                        {item.label}
                                    </Link>
                            ...
                            <Link href="/your-diary" className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium text-zinc-500 hover:text-zinc-900 hover:bg-zinc-50 transition-all">
                                <span className="text-zinc-400"><Book size={18} /></span>
                                Your Diary
                            </Link>
                        </nav>
                    </aside>
