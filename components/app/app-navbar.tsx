...
import Notifications from "@/components/app/notifications"; // Ensure import matches file location
...
const AppNavbar = () => {
    ...
    return (
        <>
            <div className='sticky top-0 left-0 z-40 bg-white dark:bg-blacked animate-theme border-b border-zinc-100 dark:border-zinc-900/80'>
                    ...
                    <div className="hidden md:flex flex-1 max-w-lg mx-4">
                        <div className="relative w-full group">
                            ...
                            <input
                                ...
                                className="w-full h-10 pl-10 pr-4 rounded-full text-sm focus:outline-none transition-all 
